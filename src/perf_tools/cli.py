...
from locust_postprocess import print_ts_locust_stats_csv, print_ts_storage_stats_csv, print_ts_basepaths_csv, print_ts_locust_history_stats_csv, download_and_extract_ts_dsi_artifacts
...
if __name__ == "__main__":
    ...
    elif cmd == 'ts_locust_history_stats':
        print_ts_locust_history_stats_csv(wld)
